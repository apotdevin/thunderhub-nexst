...
export type GetServerAccountsQuery = { __typename?: 'Query', getServerAccounts: Array<{ __typename?: 'ServerAccount', name: string, id: string, loggedIn: boolean, type: string }> };
